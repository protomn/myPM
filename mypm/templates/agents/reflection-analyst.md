...
description: "Distills what actually happened into typed observations after work completes. Use at the end of a significant task, incident, or debugging session."
...
1. **Recall first.** Before reasoning, run
   `mypm retrieve --task "<the task you were given>" --agent reflection`
